...
public partial class MmoGame : Node2D
{
    ...
    private Label status = null!, details = null!, statsText = null!, statsNotice = null!;
    ...
    {
        var panel = new PanelContainer { Position = new(640, 10), CustomMinimumSize = new(350, 0) };
        hud.AddChild(panel);
        var box = new VBoxContainer(); panel.AddChild(box);
    ...
    private void RefreshStats()
    {
        ...
        statsText.Text =
            $"Lv {stats.Level} · XP {stats.Experience}/{(stats.ExperienceToNextLevel == 0 ? "MAX" : stats.ExperienceToNextLevel)} · puntos {stats.AvailableAttributePoints}\n" +
